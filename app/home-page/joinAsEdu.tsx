      ...
      <div className="flex-auto flex max-md:items-center max-md:justify-center  self-stretch px-16 py-3 rounded-xl border-2 border-indigo-500 border-solid bg-zinc-300 bg-opacity-20 max-md:px-5 max-md:max-w-full">
        <div className="flex gap-5 max-lg:flex-col justify-between w-full">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full max-lg:w-full">
            <div className="flex gap-5 justify-between items-start self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              {statsData.map((stat, index) => (
                <div className="flex gap-6 items-center" key={index}>
                <div className={`flex gap-2.5 items-center self-stretch p-2.5 my-auto   rounded-lg`}>
                  <Image
                    loading="lazy"
                    src={stat.iconSrc}
                    alt={`${stat.label} icon`}
                ...
                <div className="flex flex-col self-stretch my-auto whitespace-nowrap">
                  <div className="text-3xl font-semibold tracking-wide leading-none text-black">
                    {stat.count}
                  </div>
                  <div className="mt-2 text-xl leading-snug text-zinc-500">
                    {stat.label}
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col ml-5  max-md:ml-0 max-md:w-full max-md:w-full">
            <div className="flex max-md:flex-col max-lg:flex-col gap-9 w-full max-md:gap-3 text-3xl max-md:items-center max-lg:items-center font-semibold leading-tight text-zinc-100 max-md:mt-3 max-md:max-w-full ">
              ...
              <div className="flex gap-10 items-start pl-10 my-auto bg-[#0F509C] rounded-[50px] shadow-[0px_126px_35px_rgba(0,0,0,0)] max-md:max-w-full">
