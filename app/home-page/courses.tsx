...
export const Courses: React.FC = () => {
  const coursesData: CoursesPropsD = {
    courses: [
      {
        imageUrl:
          "https://cdn.builder.io/api/v1/image/assets/0875a60df1154a34920056571d8491d3/c290e4f9201b165fb509343b33ee80893aeb4eb638b03fd7a5e42bcff552a3bd?apiKey=0875a60df1154a34920056571d8491d3&",
      ...
      {
        imageUrl:
          "https://cdn.builder.io/api/v1/image/assets/0875a60df1154a34920056571d8491d3/8771675f51a50ed8d4ae6531e7ea70135b73bf62d33e1f9bac8b6fef4b4402f1?apiKey=0875a60df1154a34920056571d8491d3&",
        imageAlt: "English course illustration",
        title: "English",
        description: "Enhance language skills with expert guidance.",
      },
      {
        imageUrl:
          "https://cdn.builder.io/api/v1/image/assets/0875a60df1154a34920056571d8491d3/eb412695de09c488d5bfa0f7e555f34c5595c3888e1798181386b9709d3eab01?apiKey=0875a60df1154a34920056571d8491d3&",
        imageAlt: "Physics course illustration",
        title: "Physics",
        description: "Develop conceptual clarity with real-life examples.",
      },
      {
        imageUrl:
          "https://cdn.builder.io/api/v1/image/assets/0875a60df1154a34920056571d8491d3/9960841b4ac465d5b557b3d89ae0e1b5fcc2df990cf45f2edb1bf8f8a286f58d?apiKey=0875a60df1154a34920056571d8491d3&",
        imageAlt: "Chemistry course illustration",
        title: "Chemistry",
        description: "Master formulas and experiments with ease.",
      },
    ],
  };
    ...
    <div className="flex flex-col mt-[120px] w-full p-0">
      ...
      <div className="flex flex-col pt-8 pb-6 px-20 mt-8 w-full bg-[#0F509C]">
        ...
        >
          ...
          >
            {coursesData.courses.map((course, index) => (
              <div
                key={index}
                className={`flex-none w-full md:w-1/2 lg:w-1/4 px-4 mb-8`}
              >
        ...
        <div className="flex gap-3 justify-center mt-7">
          {[...Array(coursesData.courses.length - visibleCourses + 1)].map(
            (_, i) => (
              <div
                key={i}
                className={`h-3 rounded-full ${
                  i === currentIndex ? "w-12 bg-gray-100" : "w-3 bg-zinc-300"
                }`}
              />
            )
          )}
